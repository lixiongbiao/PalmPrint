...
if __name__== "__main__" :
    ...
    best_net = ccnet(num_classes=num_classes1,weight=comp_weight)
    net.cuda()
...
# python train.py --id_num 1000 --train_set_file data/train_Tongji_MPD.txt --test_set_file data/test_Tongji_MPD.txt --lr 0.0001 --gpu_id 0,1 --epoch_num 30